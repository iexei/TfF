# -*- coding: utf-8 -*-
# cuman recodean ini.
#Jangan Lupa Subscribe Channel YoutubeKu Ya :)
...
logo = "\033[33;1m\t\tTOOLS FOR FACEBOOK\n\033[31;1m•═════════════════════════════════════════•\033[0;1m\n    ^ \033[34;1m  Author :\033[0;1m MasPutra                    ^\n    ^  \033[34;1m Youtube : \033[34;1m\033[0;1miExEi HD                   ^\n    ^  \033[34;1m Github : \033[0;1mhttps://github.com/iexei    ^\n    ^   \033[34;1mTeam :\033[0;1m Lead Cyber Team               ^\n\033[31;1m╚═════════════════════════════════════════╝"  '\n\033[0;1m[*] Silahkan Login Operamini Agar Tidak Checkpoint\n'
...
def login():
    ...
    try:
        ...
        print '\x1b[1;91m[\xe2\x98\x86] \x1b[1;92mLOGIN DULU GAYN \x1b[1;91m[\xe2\x98\x86]'
        id = raw_input('\x1b[1;91m[+] \x1b[1;36mEmail \x1b[1;91m:\x1b[1;92m ')
        pwd = getpass.getpass('\x1b[1;91m[+] \x1b[1;36mSandimMu \x1b[1;91m:\x1b[1;92m ')
        tik()
        try:
                ...
                if zedd == '3':
                    ...
                    if zedd == '4':
                        ...
                        if zedd == '5':
                            ...
                            if zedd == '6':
                                os.system('rm -rf login.txt')
				os.system('xdg-open https://www.youtube.com/channel/UCXH3_us2c0knkneFVFDAawQ')
                                keluar()
                            else:
                                if zedd == '0':
                                    keluar()
